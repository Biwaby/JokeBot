...
public class ControllerLogAspect {
    @Pointcut("execution(public * com.biwaby.projects.jokebot.controller.*.*(..))")
    ...
    public void afterCallController(JoinPoint joinPoint, ResponseEntity<?> object) {
        log.info("\u001B[33m[CONTROLLER]: controller {} returned {}\u001B[0m", joinPoint.getSignature().getName(), object.getBody());
    }
}
